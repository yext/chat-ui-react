...
const builtInCssClasses: ChatPopUpCssClasses = {
  container: "fixed bottom-6 right-4 lg:bottom-14 lg:right-10 flex flex-col gap-y-4 items-end",
  panel: "w-80 lg:w-96 h-[75vh]",
  panel__display: "animate-[fade-in_0.3s_forwards]",
  panel__hidden: "animate-[fade-out_0.3s_forwards]",
  button: "w-12 h-12 lg:w-16 lg:h-16 flex justify-center items-center text-xl text-white shadow-xl rounded-full bg-gradient-to-br from-blue-600 to-blue-700 hover:-translate-y-2 duration-150"
}
  ...
  return (
    <div className={cssClasses.container}>
      <div className={panelCssClasses} aria-label="Popup Panel">
        {panel ?? <ChatPanel header={<ChatHeader title="Chat" showRefreshButton={true}/>} />}
      </div>
      <button aria-label='Chat Popup Button' onClick={onClick} className={cssClasses.button}>
