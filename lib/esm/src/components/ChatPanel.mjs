...
function ChatPanel(props) {
    ...
    return (jsx("div", { className: "yext-chat", children: jsxs("div", { className: cssClasses.container, children: [header, jsx("div", { className: cssClasses.messagesScrollContainer, children: jsxs("div", { ref: messagesRef, className: cssClasses.messagesContainer, children: [messages.map((message, index) => (createElement(MessageBubble, { ...props, customCssClasses: cssClasses.messageBubbleCssClasses, key: index, message: message }))), loading && jsx(LoadingDots, {})] }) })] }) }));
}
